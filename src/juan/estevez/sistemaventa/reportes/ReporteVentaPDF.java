 ...
 * librería iTextPDF en el classpath.
 * 
...
public class ReporteVentaPDF {
	 ...
	 * @param txtTelefonoEmpresa       el teléfono de la empresa.
	 * @param txtDireccionEmpresa      la dirección de la empresa.
	 * @param txtRazonSocialEmpresa    la razón social de la empresa.
	 * @param txtDniRutVenta           el DNI/RUT del cliente de la venta.
	 * @param txtNombreClienteVenta    el nombre del cliente de la venta.
	 * @param txtTelefonoClienteVenta  el teléfono del cliente de la venta.
	 * @param txtDireccionClienteVenta la dirección del cliente de la venta.
	 * @param tableVenta               la tabla que contiene los detalles de los
	 *                                 productos vendidos.
	...
	public void generarReporteVenta(String txtRutEmpresa, String txtNombreEmpresa, String txtTelefonoEmpresa,
		...
		if (response == JFileChooser.APPROVE_OPTION) {
			...
			FileOutputStream archivo = new FileOutputStream(chosenFile);
